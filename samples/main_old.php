    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">ZHANGS PROJECT</a>
        </div>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="pno.php">PHYSICIAN AND OPERATION INFO</a></li>
            <li><a href="ope.php">OPERATIONS INFO</a></li>
            <li><a href="avgop.html">OPERATIONS PAGE</a></li>
            <li><a href="avgph.html">PHYSICIANS PAGE</a></li>
            <li><a href="time.html">PHYSICIANS AND OPERATIONS PAGE</a></li>
...
foreach($name as $selected)
 ...
 $phy_name[$i++]=$selected;
  ...
  $query = "select firstname,operationname,referencedose,DAP,florencetime from generaltable g,physiciantable p where operationname
  in ('".$ope_name[0]."','".$ope_name[1]."','".$ope_name[2]."') and
  p.firstname in ('".$phy_name[0]."','".$phy_name[1]."','".$phy_name[2]."') and
  g.physicianID=p.physicianID and g.operationdate between '".$_POST['start_date']."'  and '".$_POST['end_date']."'";
...
$doc_name10="doctor J";
 ...
 $query = "select g.operationdate,referencedose from generaltable g,physiciantable p where
 operationname in ('".$ope_name[0]."','".$ope_name[1]."','".$ope_name[2]."') and
...
foreach($name as $selected)
 ...
 echo "<br>";
    $query = "select operationname,operationdate,referencedose,DAP,florencetime from generaltable where operationname
  in ('".$ope_name[0]."','".$ope_name[1]."','".$ope_name[2]."') and
