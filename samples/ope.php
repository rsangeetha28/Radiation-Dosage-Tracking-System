...
?>
<form action="type_operation.php" method="post">
<p><center> 
<div class="container">
<input type="checkbox" name= "operation" value="RIG" >RIG<br><br>
<input type="checkbox" name= "operation" value="TIPS">TIPS<br><br>
<input type="checkbox" name= "operation" value="RFA" >RFA<br><br>
<input type="checkbox" name= "operation" value="IVC">IVC<br><br>
<input type="checkbox" name= "operation" value="BIOSPY">BIOSPY<br><br><br><br>
</div>

<input type="submit" value="OPERATION NAME"></center></p>
</form>
