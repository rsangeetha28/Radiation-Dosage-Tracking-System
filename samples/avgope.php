...
<html lang="en">
  ...
  <body>
<center><h1><b>AVERAGE REFERENCE DOSAGE FOR OPERATIONS</b></h1></center><br><br>
<?php
session_start();
$user = $_SESSION['user'];
...
for($x=0;$x<$arrlength;$x++)
  ...
  echo "<b>";
    ...
    echo "</b>";
     ...
     $query2= "select p.firstname,g.referencedose from operationstable g, physiciantable p where g.operationname in ('".$ope_name[0]."','".$ope_name[1]."','".$ope_name[2]."','".$ope_name[3]."','".$ope_name[4]."') and p.physicianid = g.physicianid ";
 $result2 = mysqli_query($con,$query2);
  echo "<center>";
         echo "<table border='4'>"; // start a table tag in the HTML
    echo "<tr><th>DOCTOR NAME</th><th>REFERENCE DOSE</th><tr>";
  ...
  //echo $row2[0].$row2[1]."<br>";
   ...
   echo "</table>"; //Close the table in HTML
     ...
     echo "Average of reference dosage for selected operations is : ";
  echo "</b>";
  $query1 = "select avg(referencedose) from operationstable where operationname in ('".$ope_name[0]."','".$ope_name[1]."','".$ope_name[2]."','".$ope_name[3]."','".$ope_name[4]."') ";
