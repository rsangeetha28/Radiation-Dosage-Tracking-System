...
highlightStroke: "rgba(192,192,192,1)",
		...
		{
		document.write("<td>");
		document.write("<div class='box3'></div>");
		document.write("</td>");
		document.write("<td>");
		document.write("&nbsp;&nbsp; <?php echo $_SESSION["phy_name_all"][$k2];?>&nbsp;&nbsp;");
		document.write("</td>");	
		}
		if(count>=4)
		{
		document.write("<td>");
		document.write("<div class='box4'></div>");
		document.write("</td>");
		document.write("<td>");
		document.write("&nbsp;&nbsp; <?php echo $_SESSION["phy_name_all"][$k3];?>&nbsp;&nbsp;");
		document.write("</td>");	
		}
		if(count>=5)
		{
		document.write("<td>");
		document.write("<div class='box5'></div>");
		document.write("</td>");
		document.write("<td>");
		document.write("&nbsp;&nbsp; <?php echo $_SESSION["phy_name_all"][$k4];?>&nbsp;&nbsp;");
		document.write("</td>");
		}
		document.write("</tr>");	
		document.write("<tr>");
		...
		{
		document.write("<td>");
		document.write("<br> <div class='box6'></div></br>");
		document.write("</td>");
		document.write("<td>");
		document.write("&nbsp;&nbsp; <?php echo $_SESSION["phy_name_all"][$k5];?>&nbsp;&nbsp;");
		document.write("</td>");	
		}
		if(count>=7)
		{
		document.write("<td>");
		document.write("<div class='box7'></div>");
		document.write("</td>");
		document.write("<td>");
		document.write("&nbsp;&nbsp; <?php echo $_SESSION["phy_name_all"][$k6];?>&nbsp;&nbsp;");
		document.write("</td>");	
		}
		if(count>=8)
		{
		document.write("<td>");
		document.write("<div class='box8'></div>");
		document.write("</td>");
		document.write("<td>");
		document.write("&nbsp;&nbsp; <?php echo $_SESSION["phy_name_all"][$k7];?>&nbsp;&nbsp;");
		document.write("</td>");	
		}
		if(count>=9)
		{
		document.write("<td>");
		document.write("<div class='box9'></div>");
		document.write("</td>");
		document.write("<td>");
		document.write("&nbsp;&nbsp; <?php echo $_SESSION["phy_name_all"][$k8];?>&nbsp;&nbsp;");
		document.write("</td>");	
		}
		if(count>=10)
		{
		document.write("<td>");
		document.write("<div class='box10'></div>");
		document.write("</td>");
		document.write("<td>");
		document.write("&nbsp;&nbsp; <?php echo $_SESSION["phy_name_all"][$k9];?>&nbsp;&nbsp;");
		document.write("</td>");	
		}
		document.write("</tr>");
		document.write("</table>");                                                                                 	
