...
<html lang="en">
  ...
  <body>
  <center><h1><b>PHYSICIANS INFORMATION</b></h1></center><br><br>
  <div class="container">
  <p1> Please click below to get complete information about physicians.</p1>
  </div>
<form action ="physician_details.php" method="post">
<p><center><input type="submit" value="PHYSICIAN DETAILS"></center></p>
</form>
