...
$count=0; 
if($_POST['fname'] == FALSE AND $_POST['lname'] == FALSE AND $_POST['height'] == FALSE AND $_POST['weight'] == FALSE)
{
	...
	{
		$sql="INSERT INTO patienttable(firstName,lastName,height,weight,patientID)
		VALUES
		('$patdata[0]','$patdata[1]','$patdata[2]','$patdata[3]',NULL)";
		$count++;
...
else
{
	$sql="INSERT INTO patienttable(firstName,lastName,height,weight,patientID)
	VALUES
	('".$_POST['fname']."','".$_POST['lname']."','".$_POST['height']."','".$_POST['weight']."',NULL)";
	$count++;
	if (!mysqli_query($con,$sql))
	{
	echo('Error in connecting  ' . mysql_error());
