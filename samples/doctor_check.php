...
<html lang="en">
  ...
  <body>
<center><h1><b>PHYSICIAN AND OPERATIONS DETAILS</b></h1></center><br><br>
<?php
session_start();
$user = $_SESSION['user'];
...
$query = "select * from operationstable g where  g.operationdate between '".$_POST['date3']."'  and '".$_POST['date4']."'  and g.physicianid in
(select physicianid from physiciantable p where p.physicianID='".$_POST['doctor_name']."') ";

$result = mysqli_query($con,$query);
echo "<center>";
 echo "<table border='3'>"; // start a table tag in the HTML

	echo "<tr><th>OPERATION NAME&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th>OPERATION DATE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
	<th>DAP&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th>REFERENCE DOSAGE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
	<th>FLUOROSCOPY TIME&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><tr>";
  ...
  echo "<tr><td>" . $row['operationname'] ."</td><td>" . $row['operationdate'] ."</td><td>" .$row['DAP'] ."</td><td>"
  .$row['referencedose']."</td><td>" .$row['florencetime']."</td></tr>";
