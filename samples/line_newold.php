...
<?php include 'main.php';
 ...
 <html>
	...
	<center>
			...
			<!-- <h1><center>Graphical Representation of Average Dosage given by <?php echo $_SESSION["phy_name"]; ?></center></h1> -->
	...
	<script>
       ...
       if (count ==1)
       {
         var lineChartData = { labels : [month1,month2,month3,month4,month5,month6,month7,month8,month9,month10,month11,month12],
		            datasets : [ { label: "My First dataset", fillColor : "rgba(192,192,192,0.0)", strokeColor : "rgba(192,192,192,1)", pointColor : "rgba(192,192,192,1)", pointStrokeColor : "#fff", pointHighlightFill : "#fff", pointHighlightStroke : "rgba(192,192,192,1)",
        ...
        document.write("<br>");
        document.writeln("Grey color graph represents average dosage given by ");
        document.writeln(doc_name[temp[i]]);
        }
       else if (count==2)
       {
         var lineChartData = { labels : [month1,month2,month3,month4,month5,month6,month7,month8,month9,month10,month11,month12],
		            datasets : [ { label: "My First dataset", fillColor : "rgba(192,192,192,0.0)", strokeColor : "rgba(192,192,192,1)", pointColor : "rgba(192,192,192,1)", pointStrokeColor : "#fff", pointHighlightFill : "#fff", pointHighlightStroke : "rgba(192,192,192,1)",
				    data : [avg1[temp[i]],avg2[temp[i]],avg3[temp[i]],avg4[temp[i]],avg5[temp[i]],avg6[temp[i]],avg7[temp[i]],avg8[temp[i]],avg9[temp[i]],avg10[temp[i]],avg11[temp[i]],avg12[temp[i]]] },
				{ label: "My Second dataset", fillColor : "rgba(0,0,255,0.0)", strokeColor : "rgba(0,0,255,1)", pointColor : "rgba(0,0,255,1)", pointStrokeColor : "#fff", pointHighlightFill : "#fff", pointHighlightStroke : "rgba(0,0,255,1)",
        ...
        document.writeln(doc_name[temp[i]]);
        document.write("<br>");
        document.writeln("Blue color graph represents average dosage given by ");
        document.writeln(doc_name[temp[i+1]]);
        }
        else if (count==3)
       {
         var lineChartData = { labels : [month1,month2,month3,month4,month5,month6,month7,month8,month9,month10,month11,month12],
				...
				{ label: "My Second dataset", fillColor : "rgba(0,0,255,0.0)", strokeColor : "rgba(0,0,255,1)", pointColor : "rgba(0,0,255,1)", pointStrokeColor : "#fff", pointHighlightFill : "#fff", pointHighlightStroke : "rgba(0,0,255,1)",
				    data : [avg1[temp[i+1]],avg2[temp[i+1]],avg3[temp[i+1]],avg4[temp[i+1]],avg5[temp[i+1]],avg6[temp[i+1]],avg7[temp[i+1]],avg8[temp[i+1]],avg9[temp[i+1]],avg10[temp[i+1]],avg11[temp[i+1]],avg12[temp[i+1]]] },
				{ label: "My Third dataset", fillColor : "rgba(255,0,0,0.0)", strokeColor : "rgba(255,0,0,1)", pointColor : "rgba(255,0,0,1)", pointStrokeColor : "#fff", pointHighlightFill : "#fff", pointHighlightStroke : "rgba(255,0,0,1)",
        ...
        document.writeln(doc_name[temp[i+1]]);
        document.write("<br>");
        document.writeln("Red color graph represents average dosage given by ");
        document.writeln(doc_name[temp[i+2]]);
        }
       else if (count==4)
       {
         var lineChartData = { labels : [month1,month2,month3,month4,month5,month6,month7,month8,month9,month10,month11,month12],
				...
				{ label: "My Third dataset", fillColor : "rgba(255,0,0,0.0)", strokeColor : "rgba(255,0,0,1)", pointColor : "rgba(255,0,0,1)", pointStrokeColor : "#fff", pointHighlightFill : "#fff", pointHighlightStroke : "rgba(255,0,0,1)",
				    data : [avg1[temp[i+2]],avg2[temp[i+2]],avg3[temp[i+2]],avg4[temp[i+2]],avg5[temp[i+2]],avg6[temp[i+2]],avg7[temp[i+2]],avg8[temp[i+2]],avg9[temp[i+2]],avg10[temp[i+2]],avg11[temp[i+2]],avg12[temp[i+2]]] },
				{ label: "My Fourth dataset", fillColor : "rgba(128,0,0,0.0)", strokeColor : "rgba(128,0,0,1)", pointColor : "rgba(128,0,0,0.7)", pointStrokeColor : "#fff", pointHighlightFill : "#fff", pointHighlightStroke : "rgba(128,0,0,1)",
        ...
        document.writeln(doc_name[temp[i+2]]);
        document.write("<br>");
        document.writeln("Maroon color graph represents average dosage given by ");
        document.writeln(doc_name[temp[i+3]]);
        }
       else if (count==5)
       {
         var lineChartData = { labels : [month1,month2,month3,month4,month5,month6,month7,month8,month9,month10,month11,month12],
				...
				{ label: "My Fourth dataset", fillColor : "rgba(128,0,0,0.0)", strokeColor : "rgba(128,0,0,1)", pointColor : "rgba(128,0,0,0.7)", pointStrokeColor : "#fff", pointHighlightFill : "#fff", pointHighlightStroke : "rgba(128,0,0,1)",
				    data : [avg1[temp[i+3]],avg2[temp[i+3]],avg3[temp[i+3]],avg4[temp[i+3]],avg5[temp[i+3]],avg6[temp[i+3]],avg7[temp[i+3]],avg8[temp[i+3]],avg9[temp[i+3]],avg10[temp[i+3]],avg11[temp[i+3]],avg12[temp[i+3]]] },
				{ label: "My Fifth dataset", fillColor : "rgba(128,128,0,0.0)", strokeColor : "rgba(128,128,0,1)", pointColor : "rgba(128,128,0,1)", pointStrokeColor : "#fff", pointHighlightFill : "#fff", pointHighlightStroke : "rgba(128,128,0,1)",
        ...
        document.writeln(doc_name[temp[i+3]]);
        document.write("<br>");
        document.writeln("Olive color graph represents average dosage given by ");
        document.writeln(doc_name[temp[i+4]]);
        }
       else if (count==6)
       {
         var lineChartData = { labels : [month1,month2,month3,month4,month5,month6,month7,month8,month9,month10,month11,month12],
				...
				{ label: "My Fifth dataset", fillColor : "rgba(128,128,0,0.0)", strokeColor : "rgba(128,128,0,1)", pointColor : "rgba(128,128,0,1)", pointStrokeColor : "#fff", pointHighlightFill : "#fff", pointHighlightStroke : "rgba(128,128,0,1)",
				    data : [avg1[temp[i+4]],avg2[temp[i+4]],avg3[temp[i+4]],avg4[temp[i+4]],avg5[temp[i+4]],avg6[temp[i+4]],avg7[temp[i+4]],avg8[temp[i+4]],avg9[temp[i+4]],avg10[temp[i+4]],avg11[temp[i+4]],avg12[temp[i+4]]] },
				{ label: "My sixth dataset", fillColor : "rgba(0,128,128,0.0)", strokeColor : "rgba(0,128,128,1)", pointColor : "rgba(0,128,128,1)", pointStrokeColor : "#fff", pointHighlightFill : "#fff", pointHighlightStroke : "rgba(0,128,128,1)",
       ...
       document.writeln("Grey color graph represents average dosage given by ");
        ...
        document.writeln(doc_name[temp[i+4]]);
        document.write("<br>");
        document.writeln("Teal color graph represents average dosage given by ");
        document.writeln(doc_name[temp[i+5]]);
        }
       else if (count==7)
       {
         var lineChartData = { labels : [month1,month2,month3,month4,month5,month6,month7,month8,month9,month10,month11,month12],
				...
				{ label: "My sixth dataset", fillColor : "rgba(0,128,128,0.0)", strokeColor : "rgba(0,128,128,1)", pointColor : "rgba(0,128,128,1)", pointStrokeColor : "#fff", pointHighlightFill : "#fff", pointHighlightStroke : "rgba(0,128,128,1)",
				    data : [avg1[temp[i+5]],avg2[temp[i+5]],avg3[temp[i+5]],avg4[temp[i+5]],avg5[temp[i+5]],avg6[temp[i+5]],avg7[temp[i+5]],avg8[temp[i+5]],avg9[temp[i+5]],avg10[temp[i+5]],avg11[temp[i+5]],avg12[temp[i+5]]] },
				{ label: "My seventh dataset", fillColor : "rgba(128,0,128,0.0)", strokeColor : "rgba(128,0,128,1)", pointColor : "rgba(128,0,128,1)", pointStrokeColor : "#fff", pointHighlightFill : "#fff", pointHighlightStroke : "rgba(128,0,128,1)",
        ...
        document.writeln(doc_name[temp[i+5]]);
        document.write("<br>");
        document.writeln("Purple color graph represents average dosage given by ");
        document.writeln(doc_name[temp[i+6]]);
        }
       else if (count==8)
       {
         var lineChartData = { labels : [month1,month2,month3,month4,month5,month6,month7,month8,month9,month10,month11,month12],
				...
				{ label: "My seventh dataset", fillColor : "rgba(128,0,128,0.0)", strokeColor : "rgba(128,0,128,1)", pointColor : "rgba(128,0,128,1)", pointStrokeColor : "#fff", pointHighlightFill : "#fff", pointHighlightStroke : "rgba(128,0,128,1)",
				    data : [avg1[temp[i+6]],avg2[temp[i+6]],avg3[temp[i+6]],avg4[temp[i+6]],avg5[temp[i+6]],avg6[temp[i+6]],avg7[temp[i+6]],avg8[temp[i+6]],avg9[temp[i+6]],avg10[temp[i+6]],avg11[temp[i+6]],avg12[temp[i+6]]] },
				{ label: "My eighth dataset", fillColor : "rgba(255,255,0,0.0)", strokeColor : "rgba(255,255,0,1)", pointColor : "rgba(255,255,0,1)", pointStrokeColor : "#fff", pointHighlightFill : "#fff", pointHighlightStroke : "rgba(255,255,0,1)",
        ...
        document.writeln(doc_name[temp[i+6]]);
        document.write("<br>");
        document.writeln("Yellow color graph represents average dosage given by ");
        document.writeln(doc_name[temp[i+7]]);
        }
       else if (count==9)
       {
         var lineChartData = { labels : [month1,month2,month3,month4,month5,month6,month7,month8,month9,month10,month11,month12],
				...
				{ label: "My eighth dataset", fillColor : "rgba(255,255,0,0.0)", strokeColor : "rgba(255,255,0,1)", pointColor : "rgba(255,255,0,1)", pointStrokeColor : "#fff", pointHighlightFill : "#fff", pointHighlightStroke : "rgba(255,255,0,1)",
				    data : [avg1[temp[i+7]],avg2[temp[i+7]],avg3[temp[i+7]],avg4[temp[i+7]],avg5[temp[i+7]],avg6[temp[i+7]],avg7[temp[i+7]],avg8[temp[i+7]],avg9[temp[i+7]],avg10[temp[i+7]],avg11[temp[i+7]],avg12[temp[i+7]]] },
				{ label: "My ninth dataset", fillColor : "rgba(0,128,0,0.0)", strokeColor : "rgba(0,128,0,1)", pointColor : "rgba(0,128,0,1)", pointStrokeColor : "#fff", pointHighlightFill : "#fff", pointHighlightStroke : "rgba(0,128,0,1)",
        ...
        document.writeln(doc_name[temp[i+7]]);
        document.write("<br>");
        document.writeln("Green color graph represents average dosage given by ");
        document.writeln(doc_name[temp[i+8]]);
        }
       else if (count==10)
       {
         var lineChartData = { labels : [month1,month2,month3,month4,month5,month6,month7,month8,month9,month10,month11,month12],
				...
				{ label: "My ninth dataset", fillColor : "rgba(0,128,0,0.0)", strokeColor : "rgba(0,128,0,1)", pointColor : "rgba(0,128,0,1)", pointStrokeColor : "#fff", pointHighlightFill : "#fff", pointHighlightStroke : "rgba(0,128,0,1)",
				    data : [avg1[temp[i+8]],avg2[temp[i+8]],avg3[temp[i+8]],avg4[temp[i+8]],avg5[temp[i+8]],avg6[temp[i+8]],avg7[temp[i+8]],avg8[temp[i+8]],avg9[temp[i+8]],avg10[temp[i+8]],avg11[temp[i+8]],avg12[temp[i+8]]] },
				{ label: "My tenth dataset", fillColor : "rgba(0,0,0,0.0)", strokeColor : "rgba(0,0,0,1)", pointColor : "rgba(0,0,0,1)", pointStrokeColor : "#fff", pointHighlightFill : "#fff", pointHighlightStroke : "rgba(0,0,0,1)",
        ...
        document.writeln(doc_name[temp[i+8]]);
        document.write("<br>");
        document.writeln("Black color graph represents average dosage given by ");
        document.writeln(doc_name[temp[i+9]]);
        }
