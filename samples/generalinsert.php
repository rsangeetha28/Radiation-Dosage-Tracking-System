...
?>
<center><h1><b>INSERTION OF OPERATIONS INFORMATION</b></h1></center>
<form action="insertge.php" method="post" enctype="multipart/form-data">
<p><center>
Physician ID  :<br><input type="number" name="phyID" /><br><br>
Patient ID :<br><input type="number" name="patID" /><br><br>
Operation Name:<br><input type="text" name="opename" /><br><br>
Fluoroscopy Time :<br><input type="number" name="ftime" /><br><br>
DAP:<br><input type="number" name="dap" /><br><br>
Reference Dose:<br><input type="number" name="rdose" /><br><br>
Operation Date:<br><input type="date" name="odate" /><br><br>
<p><b>OR</b></p>
