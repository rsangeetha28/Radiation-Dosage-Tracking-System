...
<html lang="en">
  <head>
    ...
    <link href="bootstrap.min.css" rel="stylesheet">
	  <link href="pateint_details.css" rel="stylesheet">
  ...
  <body>
  <center><h1><b>PATIENT DETAILS</b></h1></center><br>
  <div class="container">
<?php
...
if (mysqli_connect_errno())
  ...
  echo "Failed to connect to MySQL: " . mysqli_connect_error();
		 ...
		 $query= "select * from patienttable p,operationstable g where p.patientID=g.patientID" ;
	...
	<th>PATIENT ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th>OPERATION NAME&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
	<th>FLUOROSCOPY TIME&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th>DAP&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><tr>";
	echo "<br>";
      while($row = mysqli_fetch_array($result))
    {

echo "<tr><td>" . $row['firstname'] . "</td><td>" . $row['lastname'] ."</td><td>" .$row['height']
."</td><td>" .$row['weight']."</td><td>" .$row['patientID']."</td><td>" .$row['operationname']."</td><td>".$row['florencetime']."</td><td>"
.$row['DAP'] . "</td></tr>";
