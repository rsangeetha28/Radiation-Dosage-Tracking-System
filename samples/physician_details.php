...
<html lang="en">
  ...
  <body>
  <center><h1><b>PHYSICIAN DETAILS</b></h1></center><br>
<?php
...
if (mysqli_connect_errno())
  ...
  echo "Failed to connect to MySQL: " . mysqli_connect_error();
		 ...
		 $query= "select * from physiciantable p,operationstable g where p.physicianID=g.physicianID" ;
         $result = mysqli_query($con,$query);
		 echo "<center>";
         echo "<table border='3'>"; // start a table tag in the HTML
    echo "<tr><th>FIRST NAME&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th>LAST NAME&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th>EXPERIENCE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
	<th>PHYSICIAN ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th>OPERATION NAME&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><tr>";
      while($row = mysqli_fetch_array($result))
    {

echo "<tr><td>" . $row['firstname'] . "</td><td>" . $row['lastname'] ."</td><td>" .$row['experience']
."</td><td>" .$row['physicianID']."</td><td>" .$row['operationname']. "</td></tr>";
