...
<html lang="en">
  ...
  <center><h1><b>PHYSICIAN AND OPERATIONS PAGE</b></h1></center><br><br>

  <body>
<form action="doctor_check.php" method="post">
<p><center>
<center>PHYSICIAN</center>
<select class = "form-control" name= "doctor_name" style="max-width:10%" required>
<?php
...
$result = mysqli_query($con,"select firstname,lastname,physicianID from physiciantable");
...
<p><center><BR><br>
<input type="submit" value="SUBMIT"></center></p>
</form>
