...
?>
<center><h1><b>INSERTION OF PHYSICIANS INFORMATION</b></h1></center><br><br>
<form action="insertpy.php" method="post" enctype="multipart/form-data">
<p><center>
Firstname  :<br><input type="text" name="fname" /><br><br>
Lastname   :<br><input type="text" name="lname" /><br><br>
Experience:<br><input type="number" name="exp" /><br><br>
<p><b>OR</b></p>
