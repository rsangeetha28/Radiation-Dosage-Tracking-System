...
$count=0; 
if($_POST['patID'] == FALSE AND $_POST['phyID'] == FALSE AND $_POST['opename'] == FALSE AND $_POST['ftime'] == FALSE 
	AND $_POST['dap'] == FALSE AND $_POST['rdose'] == FALSE AND $_POST['odate'] == FALSE)
{
	...
	{
		$sql="INSERT INTO operationstable(operationID,patientID,physicianID,operationname,florencetime,DAP,referencedose,operationdate)
		VALUES
		(NULL,'$patdata[0]','$patdata[1]','$patdata[2]','$patdata[3]','$patdata[4]','$patdata[5]','$patdata[6]')";
		$count++;
...
else
{
	$sql="INSERT INTO operationstable(operationID,patientID,physicianID,operationname,florencetime,DAP,referencedose,operationdate)
	VALUES
	(NULL,'".$_POST['patID']."','".$_POST['phyID']."','".$_POST['opename']."','".$_POST['ftime']."','".$_POST['dap']."','".$_POST['rdose']."','".$_POST['odate']."')";
	$count++;
	if (!mysqli_query($con,$sql))
	{
	echo('Error in connecting  ' . mysql_error());
